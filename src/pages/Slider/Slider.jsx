...
const Slider = () => {
  return (
<div className="-14 bg-linear-65 from-purple-500 to-pink-500 p-6 rounded-md  ">
      <Container>
      <div className="flex flex-col-reverse justify-center items-center gap-8 md:flex-row lg:flex-row  ">
        <div className="flex-1">
          <h2 className="text-3xl font-semibold my-2 text-blue-900">Your Favorite Books, Delivered to Your Doorstep</h2>
          <p className="text-white ">
            Discover a massive collection of books from bestselling authors, trusted publishers, and
            rising writers from around the world. Whether you love fiction, non-fiction, or academic
            reads, we ensure fast delivery, safe packaging, and a seamless online experience
            tailored for true book lovers.
          </p>
        </div>
        <div className="w-100">
          <Swiper
