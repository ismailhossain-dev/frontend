...
const Navbar = () => {
  ...
  return (
    <div className="fixed bg-black   z-10 shadow-sm  w-full rounded-md mx-auto">
      <div className="py-4 ">
        <Container>
            ...
            <div>
              <ul className=" flex gap-3">
                <NavLink
                  ...
                  className={({ isActive }) =>
                    ` px-4 py-2 rounded transition font-semibold hidden md:block lg:block  ${
                      isActive ? "bg-green-500  text-blue-500" : "text-white "
                    }`
                  }
                >
                  Home
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    ` px-4 py-2 rounded transition font-semibold hidden md:block lg:block  ${
                      isActive ? "bg-green-500  text-white" : "text-white "
                    }`
                  }
                >
                  All Book
